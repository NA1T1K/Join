...
tokens = ["MTAzNjI4MDAyNDU4NTc0MDMwOA.GanXXl.SNZ23mFW2le98bKrgJRedmqBmzvKtZMwPnXhn4"]
channelid = "1093274493495034016"  # add channel id for msges to be posted
times = 0
print('''
...
if __name__ == "__main__":
  while True:
    ...
    msg("!join 1147749932757950514")
    time.sleep(random.randrange(125, 130))